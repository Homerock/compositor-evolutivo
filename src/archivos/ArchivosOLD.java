...
public class ArchivosOLD {
	 ...
	 **/
	//#########################################################################################
	public void procesarArchivo(String nombreArch) throws ArchivosException{
		...
		try {
			if (!fil.accept(fichero, fichero.getName())) {
				throw new ArchivosException("El formato del fichero "+ fichero.getName()+ " es incorrecto"+ArchivosOLD.class);
			...
			try {
				...
				reader.close();
				throw new ArchivosException("Error al obtener la tonica de la canción."+ArchivosOLD.class);
			}
			reader.close();
			...
			throw new ArchivosException("El Archivo '"+nombreArch+"' No existe."+ArchivosOLD.class);
		} catch (IOException e1) {
			throw new ArchivosException("Error en la lectura de archivo :"+nombreArch + ". "+ArchivosOLD.class);
		}
	}
